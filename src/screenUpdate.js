...
import { calcWashingDay } from "./washDay";
...
const washDay = document.querySelector("#wash-day");

export function updateScreen(weather, object) {
  ...
  createGraphic(weather);
  washDay.textContent = `El mejor dia para labar es el dia ${calcWashingDay(
    weather,
    object
  )}`;
}
